	...
	return (
		...
		<div className="mb-2">
			...
			<input
				...
				id={fieldName}
				className="outline-none border-2 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
				{...register(fieldName, {
					required: {
						value: isRequired,
